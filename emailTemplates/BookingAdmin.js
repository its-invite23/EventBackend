  ...
  <table align="center" style="max-width: 600px; font-family: Arial;" width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#000">
    ...
    <tr>
      <td style="padding:40px 20px 30px 20px;">
        <p style="margin: 1px; font-size: 14px; font-weight: normal; color:#CCCCCC;"> Hi Admin, </p>
      </td>
    </tr>
    <tr>
      <td style="padding: 0px 20px 20px 20px">
        <p style="margin: 1px; font-size: 14px; font-weight: normal; color:#CCCCCC;"> You’ve received a new booking request from a user! </p>
      </td>
    </tr>
    <tr>
      <td style="padding: 0px 20px 20px 20px">
        <p style="margin: 1px; font-size: 14px; font-weight: normal; color:#CCCCCC;"> Please review this booking request and take the necessary next steps. If you need further details, feel free to reach out to the user directly.</p>
      </td>
    </tr>
