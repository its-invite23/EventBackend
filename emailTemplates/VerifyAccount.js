module.exports = (VerfiyLink, userName) => {
  ...
  <tr>
    <td style="padding: 0 0 30px 20px;">
      <p style="margin: 1px; font-size: 14px; font-weight: normal; color:#CCCCCC; text-align: left;"> Thank you for signing up with us. Please proceed with verifying your account. </p>
    </td>
  </tr>
  <tr>
    <td style="padding: 0 0 30px 20px;">
      <p style="margin: 1px; font-size: 14px; font-weight: normal; color:#CCCCCC; text-align: left;"> To verify your account, please click the link below: </p>
    </td>
  </tr>
  <tr>
    <td style="padding: 15px 20px 50px 20px; text-align: left;">
  ...
  <tr>
    <td style="padding: 0 0 30px 20px;">
      <p style="margin: 1px; font-size: 14px; font-weight: normal; color:#CCCCCC"> Thank you for using [Company Name]! </p>
    </td>
  </tr>
  <tr>
