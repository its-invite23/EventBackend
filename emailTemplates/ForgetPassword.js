  ...
  <table align="center" style="max-width: 600px; font-family: arial; text-align: left; margin: 0 auto;" align="left" width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#000">
   ...
   <tr>
     <td style="padding: 0 20px 30px 10px; text-align: left;">
       <p style="margin: 1px; font-size: 14px; line-height: 18px;  font-weight: normal; color: #CCCCCC;"> For security purposes, this link will expire in 24 hours. If you need further assistance or didn’t request this reset, please reach out to our support team immediately. </p>
     </td>
   </tr>
   <tr>
     <td style="padding: 0 20px 30px 10px; text-align: left;">
