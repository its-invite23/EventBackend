const Booking = (reply_message) =>  `
<table style="max-width: 400px;" width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#000">
<tr>
...
<tr>
   <td style="padding:40px 0 45px 20px;">
       <p style="margin: 1px; font-size: 12px; font-weight: normal; color:#CCCCCC">
           Hi ${reply_message?.userId?.username},
       </p>
   </td>
</tr>
...
<tr>
   <td style="padding: 0 0 45px 40px;">
       <table>
           <tr>
               <td style="padding: 0 15px 15px 5px;">
                   <p style="margin: 1px; font-size: 12px; font-weight: normal; color:#CCCCCC">
                       Service Provider:
                   </p>
               </td>
               ...
               <td style="padding: 0 15px 15px 5px;">
                   <p style="margin: 1px; font-size: 12px; font-weight: normal; color:#fff">
                      <strong>
