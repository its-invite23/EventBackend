module.exports = (username, message) => { return ` 
    
  <table style="max-width: 600px; font-family: arial;" width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#000">
<tr bgcolor="#141414">
...
<tr>
  <td style="padding:40px 0 30px 20px;">
    <p style="margin: 1px; font-size: 12px; font-weight: normal; color:#CCCCCC"> Hi ${username} ${message}, </p>
  </td>
</tr>
<tr>
  <td style="padding: 0 0 30px 20px;">
    <p style="margin: 1px; font-size: 12px; font-weight: normal; color:#CCCCCC"> Thank you for your interest! We have successfully received your booking request for the upcoming event. </p>
  </td>
</tr>
<tr>
  <td style="padding: 0 0 30px 20px;">
    <p style="margin: 1px; font-size: 12px; font-weight: normal; color:#CCCCCC"> Our team will notify you about payment and further details in some time, and you can now relax knowing that your event is in good hands. </p>
  </td>
</tr>
<tr>
  <td style="padding: 0 0 30px 20px;">
    <p style="margin: 1px; font-size: 12px; font-weight: normal; color:#CCCCCC"> For any further questions, feel free to reach out to us anytime. </p>
  </td>
</tr>
<tr>
  <td style="padding: 0 0 30px 20px;">
    <p style="margin: 1px; font-size: 12px; font-weight: normal; color:#CCCCCC"> Thank you for choosing us to make your event special! </p>
  </td>
</tr>
<tr>
  <td style="padding: 0 0 45px 20px;">
    <p style="margin: 1px; font-size: 12px; font-weight: normal; color:#CCCCCC"> Best regards, <br>Event Management Support Team </p>
  </td>
</tr>
<tr bgcolor="#141414">
...
<tr bgcolor="#141414">
  <td style="padding: 15px 0 5px 0;border-top:1px solid #444444">
    <p style="margin: 1px; font-size: 12px; font-weight: normal; color:#CCCCCC; text-align: center;"> Thank you for choosing us to make your event special! </p>
  </td>
</tr>
<tr bgcolor="#141414">
