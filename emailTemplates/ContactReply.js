 ...
 <table align="center" style="max-width: 600px; font-family: arial;text-align: left;" align="center" width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#000">
  ...
  <tr>
    <td style="padding: 0 10px 30px 10px;">
      <p style="margin: 1px; font-size: 14px; font-weight: normal; color:#CCCCCC; text-align: left; line-height: 19px;"> Thank you for your message. Please find below the response to your message. </p>
    </td>
  </tr>
  <tr>
    <td style="padding: 0 0 45px 10px;">
      <p style="margin: 1px; font-size: 14px; font-weight: normal; color:#CCCCCC"> Message: ${message} </p>
    </td>
  </tr>
  <tr>
    <td style="padding: 0 0 45px 10px;">
...
, <br> The Invite Team 🌟</p>
  ...
  <tr bgcolor="#141414">
    <td style="padding: 15px 0 15px 0; text-align: center;">
          <table cellpadding="0" cellspacing="0" align="center">         <tr>           <td style="padding: 0 5px;">             <a href="https://www.linkedin.com/company/itsinvite" target="_blank">               <img src="https://f003.backblazeb2.com/file/Event-management/linkedicon.png" alt="">             </a>           </td>           <td style="padding: 0 5px;">             <a href="https://www.instagram.com/itsinvite_/" target="_blank">               <img src="https://f003.backblazeb2.com/file/Event-management/instagram.png" alt="">             </a>           </td>           <td style="padding: 0 5px;">             <a href="https://www.tiktok.com/(at_the_rate)itsinvite_" target="_blank">               <img src="https://f003.backblazeb2.com/file/Event-management/ri_tiktok-line.png" alt="">             </a>           </td>         </tr>       </table>
    </td>
  </tr>
  <tr bgcolor="#141414">
