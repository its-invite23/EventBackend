...
<tr>
    <td style="padding: 0 10px 30px 10px; text-align: left;">
        <p style="margin: 1px; font-size: 14px;line-height: 18px; font-weight: normal; color: #CCCCCC;">
           Please click on the below button to pay - 
          <span style="font-weight: bold; font-family: Arial, sans-serif;">
  ${CurrencyCode} ${price}
</span>
           and confirm your booking with us. 
        </p>
    </td>
</tr>
...
<tr>
    <td style="padding: 0 10px 30px 10px; text-align: left;">
        <p style="margin: 1px; font-size: 14px; line-height: 18px; font-weight: normal; color: #CCCCCC;">
            For security purposes, this link will expire in 24 hours. Please confirm your booking as we look forward to working with you.
        </p>
    </td>
</tr>
...
<tr>
    <td style="padding: 0 0 45px 10px; text-align: left;">
        <p style="margin: 1px; font-size: 14px; line-height: 20px; font-weight: normal; color: #CCCCCC;">
...
<tr bgcolor="#141414">
  <td style="padding: 0 0 5px 0; text-align: center;">
    <p style="margin: 1px; font-size: 12px; font-weight: normal; color: #CCCCCC;">
        You are receiving this email because you initiated a booking and need to complete the payment to confirm it.
    </p>
</td>
</tr>
</table>
